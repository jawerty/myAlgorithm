...
function AlgorithmEditor() {
    ...
    const getKeywords = () => {
        chrome.runtime.sendMessage({ 
            ...
            if (response.keywords) {
                setKeywords(response.keywords.sort((a, b) => {
    ...
    return <div className="algorithm-editor flex flex-column align-center justify-center">
        ...
        <TopicEditor keywords={keywords} getKeywords={getKeywords} setKeywords={setKeywords} />
    </div>
}
